...
REQUIRED_KEYS = {
    ...
    "MODIMG_FILE_WORKERS",
    "MODIMG_MAX_FILE_WORKERS",
    "MODIMG_MAX_DOWNLOAD_BYTES",
    "MODIMG_MAX_AVIF_BYTES",
    "MODIMG_URL_TIMEOUT_SEC",
    "MODIMG_MAX_URL_REDIRECTS",
    "MODIMG_ALLOW_PRIVATE_URLS",
    "MODIMG_MAX_IMAGE_DIMENSION",
    "MODIMG_MAX_IMAGE_PIXELS",
    "MODIMG_MAX_SAMPLED_FRAMES",
    "MODIMG_MAX_ANIMATION_FRAMES",
    "MODIMG_MAX_DECODED_PIXELS",
    "MODIMG_MAX_SVG_BYTES",
    "MODIMG_SVG_DEFAULT_WIDTH",
    "MODIMG_SVG_DEFAULT_HEIGHT",
    "MODIMG_SVG_MAX_RENDER_DIMENSION",
    "MODIMG_SVG_MAX_RENDER_PIXELS",
    "MODIMG_SVG_BACKGROUND",
    "MODIMG_SVG_ALLOW_DATA_IMAGES",
    "MODIMG_SVG_MAX_EMBEDDED_IMAGE_BYTES",
    "MODIMG_SVG_MAX_TOTAL_EMBEDDED_BYTES",
    "SAMPLE_FRAMES",
    "SCORE_VERBOSE",
    "SCORE_MAX_KEYS",
    ...
    "PHASH_ALLOWLIST",
    "PHASH_BLOCKLIST",
    "PHASH_LIST_MAX_BYTES",
    "PHASH_LIST_MAX_ENTRIES",
    "PHASH_MAX_HEX_LENGTH",
    "PHASH_ALLOW_DISABLE",
    "PHASH_BLOCK_DISABLE",
    ...
    "OCR_MIN_LEN",
    "TESSERACT_CMD",
    "OCR_BLOCKLIST_MAX_BYTES",
    "OCR_BLOCKLIST_MAX_PATTERNS",
    "OCR_MAX_PATTERN_CHARS",
    "OCR_MAX_TEXT_CHARS",
    "OPENNSFW2_DISABLE",
    ...
    "FORBIDDEN_SYMBOLS_YOLO_BACKEND",
    "FORBIDDEN_SYMBOLS_YOLO_MODEL",
    "FORBIDDEN_SYMBOLS_YOLO_PT_MODEL",
    "FORBIDDEN_SYMBOLS_YOLO_ONNX_MODEL",
    ...
    "FORBIDDEN_SYMBOLS_YOLO_BATCH_ENABLE",
    "FORBIDDEN_SYMBOLS_YOLO_STOP_AFTER_BLOCK",
    ...
    "OPENAI_CACHE_MAX_BYTES",
    "OPENAI_SEXUAL_MINORS_BLOCK_THRESHOLD",
    "SIGHTENGINE_DISABLE",
    "SIGHTENGINE_USER",
    "SIGHTENGINE_SECRET",
    "SIGHTENGINE_MODELS",
    "SIGHTENGINE_TIMEOUT_SEC",
    "SE_FIREARM_THRESH",
