...
REQUIRED_KEYS = {
    ...
    "FORBIDDEN_SYMBOLS_YOLO_ENABLE",
    "FORBIDDEN_SYMBOLS_YOLO_MODEL",
    "FORBIDDEN_SYMBOLS_YOLO_CONF",
    "FORBIDDEN_SYMBOLS_YOLO_IOU",
    "FORBIDDEN_SYMBOLS_YOLO_IMGSZ",
    "FORBIDDEN_SYMBOLS_YOLO_MAX_DET",
    "FORBIDDEN_SYMBOLS_YOLO_MAX_FRAMES",
    "FORBIDDEN_SYMBOLS_YOLO_DEVICE",
    "FORBIDDEN_SYMBOLS_YOLO_REVIEW_CONF",
    "FORBIDDEN_SYMBOLS_YOLO_BLOCK_CONF",
    "FORBIDDEN_SYMBOLS_YOLO_INCLUDE_BOXES",
